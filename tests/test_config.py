...
class TestDefaults:
    ...
    def test_image_max_dimension_default(self, tmp_path):
        assert load_config(tmp_path / "config.yaml")["image_max_dimension"] == 2000

    def test_image_quality_default(self, tmp_path):
        assert load_config(tmp_path / "config.yaml")["image_quality"] == 85
...
class TestCustomValues:
    ...
    def test_partial_override_keeps_other_defaults(self, tmp_path):
        ...
        assert config["image_max_dimension"] == 2000
