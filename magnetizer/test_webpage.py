...
def test_webpage_write_multiple_from_filenames():
    ...
    filenames = ['001-basic-article.md', '002-article-with-h1-break-and-date.md',
                 ...
                 '009-unindexed-article.md','unindexed-static-page.md']
    ...
    assert 'unindexed-static-page.html' in written_filenames
    ...
    # ... except for the unindexed items
    assert 'https://example.com/unindexed-article.html' not in TEST_WEBSITE.sitemap.pages
    assert 'unindexed-static-page.html' not in TEST_WEBSITE.sitemap.pages
